      ...
      <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="#">Company Panel</a>
        ...
        <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">View Admin</div>
                                <div class="muted pull-right"><a href="<?php echo base_url(). 'manager/admin'?>"><button type="reset" class="btn">Back</button></a></div>
                            </div>
          ...
          <form enctype="multipart/form-data" method="POST" action="#" class="form-horizontal black" role="form">
              ...
              <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="firstname" data-required="1" required value="<?php echo $data['f_name']; ?>" class="span6 m-wrap form-control"/>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="middlename" data-required="1" required value="<?php echo $data['m_name']; ?>" class="span6 m-wrap form-control"/>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="lastname" data-required="1" required value="<?php echo $data['l_name']; ?>" class="span6 m-wrap form-control"/>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="phonenumber" data-required="1" required value="<?php echo $data['phone_no']; ?>" class="span6 m-wrap form-control"/>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                                    <select name="gender" type="text" required value="<?php echo $data['gender']; ?>" class="span6 m-wrap form-control">
          ...
          <?php 
                        ...
                        ?>
                                 ...
                                 <a href="<?php echo base_url(). 'manager/admin'?>"><button type="reset" class="btn">Back</button></a>
