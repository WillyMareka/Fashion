        ...
        <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">View Type</div>
                                <div class="muted pull-right"><a href="<?php echo base_url(). 'manager/type'?>"><button type="reset" class="btn">Back</button></a></div>
                            </div>
          ...
          <?php foreach ($type as $key => $value) {
                           ...
                           //echo '<pre>';print_r($user);echo'</pre>';die();
                            ...
                            ?>
					<form enctype="multipart/form-data" method="POST" action="<?php echo base_url() . 'manager/typeupdate'?>" class="form-horizontal black" role="form">
						<?php 
                                  echo form_open_multipart(base_url().'manager/typeupdate');
                              ?>
                        <fieldset>
              ...
              <div class="control-group">
                                <label class="control-label">Type ID. <?php echo $data['type_id']; ?></label>
                                <div class="controls">
                                    <input name="id" type="hidden"  value="<?php echo $data['type_id']; ?>" class="span6 m-wrap form-control "/>
                                </div>
                            </div>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="typename" data-required="1" required value="<?php echo $data['type_name']?>" class="span6 m-wrap form-control"/>
  								</div>
  							</div>
          ...
          <?php 
                        ...
                        ?>
                                 ...
                                 <a href="<?php echo base_url(). 'manager/type'?>"><button type="reset" class="btn">Back</button></a>
