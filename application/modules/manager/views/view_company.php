        ...
        <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right"><a href="<?php echo base_url(). 'manager/company'?>"><button type="reset" class="btn">Back</button></a></div>
                            </div>
          ...
          <?php foreach ($company as $key => $value) {
                           ...
                           //echo '<pre>';print_r($user);echo'</pre>';die();
                            ...
                            ?>
          <form enctype="multipart/form-data" method="POST" action="<?php echo base_url() . 'manager/companyupdate'?>" class="form-horizontal black" role="form">
            <?php 
                                  echo form_open_multipart(base_url().'manager/companyupdate');
                              ?>
                        <fieldset>
          ...
          <?php 
                        ...
                        ?>
                                 ...
                                 <a href="<?php echo base_url(). 'manager/company'?>"><button type="reset" class="btn">Back</button></a>
